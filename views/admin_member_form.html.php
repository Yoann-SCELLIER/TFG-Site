                        ...
                        <div class=" row col-6">
                            <?php foreach ($jobs as $job) : ?>
                                <div class="form-check text-start">
                                    ...
                                    <input class="form-check-input border border-1 border-dark" type="checkbox" name="jobs[]" id="job<?= $job['job_id'] ?>" value="<?= $job['job_id'] ?>" <?php if (isset($member['selected_jobs']) && in_array($job['id'], $member['selected_jobs'])) echo "checked"; ?>>
                                </div>
                            <?php endforeach; ?>
                        </div>
