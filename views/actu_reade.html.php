<?php
require_once dirname(__DIR__) . '/controller/db.fn.php'; // Inclure le fichier de configuration de la base de données
require_once dirname(__DIR__) . '/crud/post.fn.php'; // Inclure le fichier des fonctions CRUD
