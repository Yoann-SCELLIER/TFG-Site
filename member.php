...
require_once dirname(__DIR__) . '\TFG\controllers\reade_member.php';
require_once dirname(__DIR__) . '\TFG\controllers\reade_job.php';
require_once dirname(__DIR__) . '\TFG\crud\member_job.fn.php';
