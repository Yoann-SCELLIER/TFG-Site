...
// Contrôleur responsable de la logique d'affichage de la liste des actualités pour l'administration
require_once dirname(__DIR__) . '\controllers\view_list_post.php';

// Vue pour afficher la table des actualités dans l'interface d'administration
