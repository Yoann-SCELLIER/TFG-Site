...
// Contrôleur responsable de la logique d'affichage des détails d'une actualité pour l'administration
require_once dirname(__DIR__) . '\controllers\view_actu.php';  

// Vue pour afficher les détails d'une actualité dans l'interface d'administration
