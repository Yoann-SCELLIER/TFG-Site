            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-white" aria-current="page" href="index.php#storySection">STORY</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="index.php#staffSection">STAFF</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="/tfg/log.php">CONNEXION</a>
                        </li>
                    </ul>
                </div>
            </div>
