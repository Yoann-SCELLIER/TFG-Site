...
require_once dirname(__DIR__) . '\TFG\components\banniere_actu.html.php';

require_once dirname(__DIR__) . '\TFG\controllers\view_list_post.php';

require_once dirname(__DIR__) . '\TFG\views\actu_contenu.html.php';
